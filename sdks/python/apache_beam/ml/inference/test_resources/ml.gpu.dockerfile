...
# Generalized Dockerfile for Beam ML workloads
# Reads dependencies from configurable requirements file for flexibility

FROM nvidia/cuda:12.4.1-devel-ubuntu22.04

# Build argument for requirements file path
...
# Path is configurable via REQUIREMENTS_FILE build arg
