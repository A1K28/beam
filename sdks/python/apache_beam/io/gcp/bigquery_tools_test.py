...
class TestBigQueryWrapper(unittest.TestCase):
  ...
  def test_insert_rows_sets_metric_on_failure(self):
    ...
    # FIX: Use a generator for the side_effect. This prevents the iterator
    # from being exhausted if the retry logic calls the mock more times than
    # expected in a flaky test run.
